...
หลังรันเสร็จแต่ละครั้ง ระบบจะอัปเดตหน้าเว็บผลลัพธ์บน GitHub Pages ให้เอง (ไฟล์ `site/index.html`) ต้องเปิดใช้ครั้งเดียวที่ **Settings → Pages → Source: GitHub Actions** (ถ้า repo เป็น private ต้องใช้ GitHub แบบเสียเงิน) นอกจากนี้หน้าเว็บจะอัปเดตราคาล่าสุด สัญญาณทางเทคนิค และ % โอกาสขึ้น/ลงทุกประมาณ 5–10 นาทีในวันที่ตลาดสหรัฐฯ เปิด (GitHub อาจเริ่มงานช้ากว่าเวลาที่ตั้งไว้ ถ้าต้องการอัปเดตทุกวินาทีให้รันแอปเต็ม)
